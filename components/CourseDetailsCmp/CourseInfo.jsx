    ...
    <div className="edn__lr__space  edn__space__top bg-[#010101] grid  xl:grid-cols-2 gap-[80px] items-start ">
      <div className="order-2 xl:order-1">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <button
            ...
            className={`w-full md:w-[260px] py-2 md:py-3 rounded-[50px] text-lg CourseUi transition
      ${activeButton === "Admission"
          ...
          <button
            ...
            className="w-full md:w-[260px] py-2 md:py-3 rounded-[50px] text-lg CourseUi  bg-[#1A1A1A] text-white hover:bg-[#FFD300] hover:text-[#010101]   flex items-center justify-center gap-2 transition"
          >
            Download Brochure
            <LuDownload />
          </button>
      ...
      <div className="order-1">
        <Image
          className="w-full h-[280px] md:h-[60vh] xl:h-[90vh] rounded-[16px] object-center object-cover"
          src={course?.img}
          alt={course?.title}
          height={600}
          width={600}
